...
$ECHO "\nInstalling magiconfig ... \n"
python -m pip install --no-cache-dir magiconfig
# python -m pip install --no-cache-dir numpy==1.22 # need this version for numba
# $ECHO "\nInstalling dcor ... \n"
# python -m pip install --no-cache-dir dcor
...
$ECHO "\nInstalling mdmm ... \n"
python -m pip install --no-cache-dir mdmm
$ECHO "\nInstalling Pillow ... \n"
python -m pip install --no-cache-dir Pillow # required for mdmm stuff to work properly
python -m pip install --no-cache-dir awkward-pandas
if [[ "$useLCG" -eq 1 ]]; then
